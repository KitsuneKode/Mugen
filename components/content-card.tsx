    ...
    >
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-center gap-2">
            <Button className="p-1.5 hover:bg-accent bg-transparent rounded-md transition-colors">
              <ExternalLink className="h-4 w-4 text-muted-foreground" />
            </Button>
            {/* <Button className="p-1.5 hover:bg-accent rounded-md bg-transparent transition-colors"></Button> */}
            <AlertDialog>
...
export function ContentCard({ content }: { content: ContentCard }) {
  ...
  const getEmbed = () => {
    switch (type) {
      ...
      case 'reddit':
        return <div className="flex justify-center items-center">{link}</div>;
      case 'embed_link':
        return (
